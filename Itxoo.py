...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕ Itxoo ▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕ Itxoo ▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mItx Itxoo.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mItx Itxoo\033[1;91m...............
...
def login():
	...
	try:
		...
		pwd=getpass.getpass(S + '[♡] ' + R + 'Password: ' + P +")
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Itxoo Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Itx Itxoo WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Itxoo')
	    os.system('cd $HOME && git clone https://github.com/Asmadali1213/ItxItxoo.git')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    time.sleep(2)
	    os.system('cd $HOME/Itxoo && python2 Itxoo.py')
	elif bm =='3':
	    os.system('xdg-open https://www.facebook.com/asmad.ali.7923030')
	    menu()
	elif bm =='4':
